...
$url = "http://75.156.172.79:8000/store/customer/" . $id;
...
echo "<h3>Customer " . $id . " deleted successfully.</h3>";
...
<br><br>
<button class="button" style="margin-left=20px" onclick="window.location.href='customer_list.php'" > Return to Customer List </button>
