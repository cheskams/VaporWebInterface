...
$url = "http://75.156.172.79:8000/store/promotion/" . $item_needed;
...
$edit_link = "window.location.href='promo_edit.php?item=" . $this_id . "'";


echo "<br><br>
<button class=\"button\" style=\"margin-left=20px\" onclick=$edit_link>Edit This Product</button>";
