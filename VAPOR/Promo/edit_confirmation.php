...
$url = "http://75.156.172.79:8000/store/promotion/" . $this_id;
...
echo "<h3>Promotion " . $this_id . " Edited Successfully</h3>";
echo "<h5>Details:</h5>";
echo "<table>
      <tr>";
echo "<th>ID</th>";
...
?>
<br><br>
<button class="button" style="margin-left=20px" onclick="window.location.href='promo_list.php'" > Return to Promotions List </button>
